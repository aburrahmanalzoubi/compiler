// Generated from C:/untitled/typescriptlexer.g4 by ANTLR 4.13.2
...
public class typescriptlexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSE", "FOR", "FUNCTION", "CLASS", "INTERFACE", "IMPORT", "EXPORT", 
			"CONST", "LET", "VAR", "FROM", "SELECTOR", "STANDALONE", "IMPORTS", "STRING_TYPE", 
			"NUMBER_TYPE", "BOOLEAN_TYPE", "ANY_TYPE", "VOID_TYPE", "COMMA", "COLON", 
			"DOT", "SEMICOLON", "EQUALS", "ASSIGN", "PLUS", "MINUS", "STAR", "SLASH", 
			"LESS", "GREATER", "EQUAL", "NOT_EQUAL", "LPAREN", "RPAREN", "LBRACE", 
			"RBRACE", "ID", "STRING_LIT", "NUMBER_LIT", "WS", "LINE_COMMENT", "BLOCK_COMMENT", 
